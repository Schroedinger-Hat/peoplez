...
export default function MembershipRejectedEmail() {
  return (
    <>
      <Html>
        <Head />
        ...
        <Body style={main}>
          <Container style={container}>
            ...
            <Heading style={heading}>
              Hey there! There was a change in your membership status
            </Heading>
            <Section style={body}>
              <Text style={paragraph}>
                If you are receiving this email, it means that your membership
                has been rejected. We are sorry. If you have any questions,
                please contact us.
              </Text>
            </Section>
