...
export default async function Layout({
    ...
    if (!isLoggedIn) {
        return <main className="h-screen flex justify-center items-center bg-zinc-900">
            {unauthenticated}
        </main>
    }
                ...
                <CardHeader>
                    ...
                    <CardDescription>
                        <p className={'text-md text-gray-800'}>
                            Your account does not have the required permissions to access the admin portal.
                        </p>
                    </CardDescription>
                </CardHeader>
