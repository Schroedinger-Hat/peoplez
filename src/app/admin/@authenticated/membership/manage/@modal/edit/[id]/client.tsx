...
export function AdminMembershipEditPageClient({previousValues}: AdminMembershipEditPageClient) {
    ...
    return <AdminMembershipCRUDForm intent={CRUDFormIntent.Edit} previousValues={previousValues}
                                    onSuccess={onSubmit}/>
}