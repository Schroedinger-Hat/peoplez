        ...
        return (
            <div className="grid min-h-screen w-full md:grid-cols-[220px_1fr] lg:grid-cols-[280px_1fr]">
                ...
                <div className="flex flex-col">
                    <header
                        className="flex h-14 between justify-between md:justify-end content-between items-center gap-4 border-b bg-muted/40 px-4 lg:h-[60px] lg:px-6">
                        <Sheet>
